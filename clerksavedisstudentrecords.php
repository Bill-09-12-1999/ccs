  ...
  <body>
    ...
    <center><div class="table">
      <table>
        ...
        <tbody>
                <?php
                $query = 'SELECT * FROM `registrarisrecords` ORDER BY name ASC';
            ...
            <tr>
                ...
                <td><a href="clerkisviewgrade.php?id=<?php echo $result['id'];?>" id="view">view info</td>
                <td><a href="clerkiseditgrade.php?id=<?php echo $result['id'];?>" id="edit">Edit</td>
                <td><a href="clerkprint2.php?id=<?php echo $result['id'];?>" id="print">Print</td>
            </tr>
            <?php
      }
      } else {
