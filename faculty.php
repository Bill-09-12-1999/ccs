  ...
  <body>
    <div id="mainbox" onclick="openfunction()">&#9776;</div>
        <div id="menu" class="sidemenu">
          <ul>
              <li><a href="admin.php" class="admin"><svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
          ...
          <ul>
              <li>
                <a href="index.php" class="faculty"><svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
      ...
      <div class="login-box">
          ...
          <h1 style="text-align:center; font-family:Arial Black; color:white; letter-spacing:4px;text-shadow: 2px 2px 5px black;">HELLO FACULTY <br> <p style="font-family: arial;font-size: 20px;letter-spacing: 0;">Login Here </p></h1><br><br>
          <form action="facultyprog.php" method="POST">
