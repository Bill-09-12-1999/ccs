...
<div class="BSIT" id="BSIT">
    ...
    <div class="grade">
     ...
     <table cellspacing="0">
      ...
      ";} else{ include './download/Ist1.php';}?>
   ...
   <div class="in">
     ...
     ";} else{ include './download/Ist2.php';}?>
  ...
  <div class="in">
     ...
     <table cellspacing="0">
      ...
      <?php
       ...
       if($result['grade']==0.0 AND $result['grade2']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
      ";} else{ include './download/IstSemSec.php';}?>
   ...
   <div class="in">
     ...
     <?php
      ...
      if($result['grade11']==0.0 AND $result['grade12']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
     ";} else{ include './download/Sec2.php';}?>
   ...
   <?php
      $query = "SELECT * FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
      $result= mysqli_fetch_array($results);
  ?>
  ...
  <div class="in">
     ...
     <table cellspacing="0">
      ...
      <?php
       ...
       if($result['grade']==0.0 AND $result['grade2']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
      ";} else{ include './download/Thir1.php';}?>
   ...
   <div class="in">
     ...
     <?php
      ...
      if($result['grade']==0.0 AND $result['grade2']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
     ";} else{ include './download/Thir2.php';}?>
...
<?php
    $query = "SELECT * FROM `midyear` WHERE `studentid`= '$studentid'";
    $results = mysqli_query($link,$query);
    $result= mysqli_fetch_array($results);
     ?>
  ...
  <div class="in">
   ...
   <?php
    $query = "SELECT * FROM `fourthyear` WHERE `studentid`= '$studentid'";
    $results = mysqli_query($link,$query);
    $result= mysqli_fetch_array($results);
     ?>
  ...
  <div class="in">
     ...
     <table cellspacing="0">
      ...
      <?php
       ...
       if($result['grade']==0.0 AND $result['grade2']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
      ";} else{ include './download/For1.php';}?>
...
<?php
 ...
 if($result['grade11']==0.0 AND $result['grade12']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
";} else{ include './download/For2.php';}?>
...
<script>
  ...
  var oo= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avga3= parseFloat(
    <?php
      $query = "SELECT sum(grade) as totalavg41 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var pp= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgb3= parseFloat(
    <?php
      $query = "SELECT sum(grade2) as totalavg42 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var qq= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgc3= parseFloat(
    <?php
      $query = "SELECT sum(grade3) as totalavg43 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var rr= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgd3= parseFloat(
    <?php
      $query = "SELECT sum(grade4) as totalavg44 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ss= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avge3= parseFloat(
    <?php
      $query = "SELECT sum(grade5) as totalavg45 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var tt= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgf3= parseFloat(
    <?php
      $query = "SELECT sum(grade6) as totalavg46 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var uu= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgg3= parseFloat(
    <?php
      $query = "SELECT sum(grade7) as totalavg47 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var vv= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgh3= parseFloat(
    <?php
      $query = "SELECT sum(grade8) as totalavg48 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ww= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgi3= parseFloat(
    <?php
      $query = "SELECT sum(grade9) as totalavg49 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var xx= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgj3= parseFloat(
    <?php
      $query = "SELECT sum(grade10) as totalavg50 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var yy= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgk3= parseFloat(
    <?php
      $query = "SELECT sum(grade11) as totalavg51 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var zz= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgl3= parseFloat(
    <?php
      $query = "SELECT sum(grade12) as totalavg52 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var aaa= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgm3= parseFloat(
    <?php
      $query = "SELECT sum(grade13) as totalavg53 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var bbb= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgn3= parseFloat(
    <?php
      $query = "SELECT sum(grade14) as totalavg54 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ccc= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgo3= parseFloat(
    <?php
      $query = "SELECT sum(grade15) as totalavg55 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ddd= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgp3= parseFloat(
    <?php
      $query = "SELECT sum(grade16) as totalavg56 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var eee= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgq3= parseFloat(
    <?php
      $query = "SELECT sum(grade17) as totalavg57 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var fff= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgr3= parseFloat(
    <?php
      $query = "SELECT sum(grade18) as totalavg58 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ggg= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgs3= parseFloat(
    <?php
      $query = "SELECT sum(grade19) as totalavg59 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var hhh= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgt3= parseFloat(
    <?php
      $query = "SELECT sum(grade20) as totalavg60 FROM `thirdyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var iii= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avga4= parseFloat(
    <?php
      $query = "SELECT sum(grade) as totalavg61 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var jjj= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgb4= parseFloat(
    <?php
      $query = "SELECT sum(grade2) as totalavg62 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var kkk= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgc4= parseFloat(
    <?php
      $query = "SELECT sum(grade3) as totalavg63 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var lll= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgd4= parseFloat(
    <?php
      $query = "SELECT sum(grade4) as totalavg64 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var mmm= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avge4= parseFloat(
    <?php
      $query = "SELECT sum(grade5) as totalavg65 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var nnn= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgf4= parseFloat(
    <?php
      $query = "SELECT sum(grade6) as totalavg66 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ooo= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgg4= parseFloat(
    <?php
      $query = "SELECT sum(grade7) as totalavg67 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ppp= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgh4= parseFloat(
    <?php
      $query = "SELECT sum(grade8) as totalavg68 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var qqq= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgi4= parseFloat(
    <?php
      $query = "SELECT sum(grade9) as totalavg69 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var rrr= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgj4= parseFloat(
    <?php
      $query = "SELECT sum(grade10) as totalavg70 FROM `midyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var sss= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avga5= parseFloat(
    <?php
      $query = "SELECT sum(grade) as totalavg71 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ttt= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgb5= parseFloat(
    <?php
      $query = "SELECT sum(grade2) as totalavg72 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var uuu= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgc5= parseFloat(
    <?php
      $query = "SELECT sum(grade3) as totalavg73 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var vvv= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgd5= parseFloat(
    <?php
      $query = "SELECT sum(grade4) as totalavg74 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var www= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avge5= parseFloat(
    <?php
      $query = "SELECT sum(grade5) as totalavg75 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var xxx= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgf5= parseFloat(
    <?php
      $query = "SELECT sum(grade6) as totalavg76 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var yyy= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgg5= parseFloat(
    <?php
      $query = "SELECT sum(grade7) as totalavg77 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var zzz= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgh5= parseFloat(
    <?php
      $query = "SELECT sum(grade8) as totalavg78 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var aaaa= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgi5= parseFloat(
    <?php
      $query = "SELECT sum(grade9) as totalavg79 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var bbbb= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgj5= parseFloat(
    <?php
      $query = "SELECT sum(grade10) as totalavg80 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var cccc= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgk5= parseFloat(
    <?php
      $query = "SELECT sum(grade11) as totalavg81 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var dddd= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgl5= parseFloat(
    <?php
      $query = "SELECT sum(grade12) as totalavg82 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var eeee= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgm5= parseFloat(
    <?php
      $query = "SELECT sum(grade13) as totalavg83 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ffff= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgn5= parseFloat(
    <?php
      $query = "SELECT sum(grade14) as totalavg84 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var gggg= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgo5= parseFloat(
    <?php
      $query = "SELECT sum(grade15) as totalavg85 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var hhhh= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgp5= parseFloat(
    <?php
      $query = "SELECT sum(grade16) as totalavg86 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var iiii= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgq5= parseFloat(
    <?php
      $query = "SELECT sum(grade17) as totalavg87 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var jjjj= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgr5= parseFloat(
    <?php
      $query = "SELECT sum(grade18) as totalavg88 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var kkkk= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgs5= parseFloat(
    <?php
      $query = "SELECT sum(grade19) as totalavg89 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var llll= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgt5= parseFloat(
    <?php
      $query = "SELECT sum(grade20) as totalavg90 FROM `fourthyear` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
