...
<body>
	...
	<?php
						require'conn.php';
						$query=mysqli_query($link, "SELECT * FROM `firstyear`") or die(mysqli_error());
						while($fetch=mysqli_fetch_array($query)){
					?>

    <a href="archiving2.php?name=<?php echo $fetch['name']?>" id="archi1">Archive Records</a>
    			<?php
						}
	?>
...
<div class="BSIS" id="BSIS" style="display:none;">
	...
	?>
    <a href="prospectusnet.php?name=<?php echo $result['name'];?>">NET</a>
...
<div class="BSIT" id="BSIT" style="display:none;">
    ...
    if (mysqli_num_rows($results)>=1) {
                while($result=mysqli_fetch_array($results)){
	?>
    <a href="prospectus.php?name=<?php echo $result['name'];?>">WEB</a>
    <?php
      }
      } else {
?>
