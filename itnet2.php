  ...
  <body>
    <div class="sidemenu">
      <img src="images/logo.png"></img>
        <ul>
          <a href="isstudentportal.php"><li class="l1">Dashboard</li></a>
        </ul>
        <ul>
          <a href="grade2.php"><li class="l2">Grades</li></a>
        </ul>
        <ul>
          <a href="enroll2.php"><li class="l2">Enrollment Billing estimation</li></a>
        </ul>
        <ul>
          <a href="subjects2.php"><li class="l3">Subjects</li></a>
        </ul>
        <ul>
    ...
    <div class="course">
      ...
      <ul>
        <li class="s2"><a href="subjects2.php">BSIT, WDMT Major</li></a><br>
      </ul>
      <ul>
        <li class="s1"><a href="itnet2.php">BSIT, NCT Major</li></a><br>
      </ul>
      <ul>
        <li class="s2"><a href="issub2.php">BSIS, DA Major</li></a><br>
      </ul>
    </div>
    <div class="fee">
      <table>
