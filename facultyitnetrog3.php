...
<div class="links">
	<a href="facultyitrog3.php">IT WEB</a>
	<a href="facultyitnetrog3.php" id="active">IT NET</a>
	<a href="facultyisrog3.php">IS</a>
</div>
...
<br><br><br><br>
	<div class="header">
	<form action="facultyitnetrog3copy.php" method="POST">
	...
	<label>
		...
		border-left-color: white;
		border-right-color: white;">/
		<input type="text" name="section2" value="III - " id="section"
		style="width: 10%;
		border-style: solid;
		border: 1px solid black;
		border-top-color: white;
