  ...
  <body>
    ...
    <div class="sidemenu">
      <img src="images/logo.png"></img>
        ...
        <ul>
          <a href="clerksavedisstudentrecords.php"><li class="l3">Saved Reports</li></a>
        </ul>
        <ul>
      ...
      <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="clerkisviewnotacqgrade.php?id=<?php echo $result['id'];?>" id="view">view</td>
                <td><a href="issavegrade.php?id=<?php echo $result['id'];?>" id="view">Acquire Record</td>
