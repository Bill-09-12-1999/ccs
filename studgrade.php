  ...
  <body>
    <div class="sidemenu">
      <img src="images/logo.png"></img>
        ...
        <ul>
          <a href="studgrade.php"><li class="l1">Your Grades</li></a>
        </ul>
        <ul>
          <a href="upstudgrade.php"><li class="l2">Updated Grade</li></a>
        </ul>
        <ul>
    ...
    <?php
    $query = "SELECT * FROM `itgrade` WHERE `studentid`= '$studentid'";
