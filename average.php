...
<?php } ?>
	...
	<div class="header">
		...
		<p style="position:relative;margin-top:-15px;">BACHELOR OF SCIENCE IN INFORMATION TECHNOLOGY<br>(Compliant to CMO 25, s.2015 and CMO 20, s.2013)<br>Effective School Year 2018-2019<br>
			<b>Web and Mobile Development Track</b></p>
	...
	<div class="body">
		...
		<?php
		    $query = "SELECT * FROM `thirdyear` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
		...
		<?php
		    $query = "SELECT * FROM `midyear` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
		...
		<?php
		    $query = "SELECT * FROM `fourthyear` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
...
<script>
	...
	var oo= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade) as totalavg41 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var pp= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade2) as totalavg42 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var qq= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade3) as totalavg43 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var rr= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade4) as totalavg44 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ss= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade5) as totalavg45 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var tt= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade6) as totalavg46 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var uu= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade7) as totalavg47 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var vv= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade8) as totalavg48 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ww= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade9) as totalavg49 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var xx= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade10) as totalavg50 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var yy= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade11) as totalavg51 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var zz= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade12) as totalavg52 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aaa= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade13) as totalavg53 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bbb= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade14) as totalavg54 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ccc= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade15) as totalavg55 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ddd= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade16) as totalavg56 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var eee= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade17) as totalavg57 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var fff= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade18) as totalavg58 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ggg= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade19) as totalavg59 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hhh= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade20) as totalavg60 FROM `thirdyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var iii= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade) as totalavg61 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jjj= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade2) as totalavg62 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kkk= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade3) as totalavg63 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var lll= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade4) as totalavg64 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var mmm= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade5) as totalavg65 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var nnn= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade6) as totalavg66 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ooo= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade7) as totalavg67 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ppp= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade8) as totalavg68 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var qqq= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade9) as totalavg69 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var rrr= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade10) as totalavg70 FROM `midyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var sss= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade) as totalavg71 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ttt= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade2) as totalavg72 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var uuu= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade3) as totalavg73 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var vvv= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade4) as totalavg74 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var www= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade5) as totalavg75 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var xxx= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade6) as totalavg76 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var yyy= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade7) as totalavg77 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var zzz= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade8) as totalavg78 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aaaa= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade9) as totalavg79 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bbbb= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade10) as totalavg80 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var cccc= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade11) as totalavg81 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var dddd= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade12) as totalavg82 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var eeee= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade13) as totalavg83 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ffff= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade14) as totalavg84 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var gggg= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade15) as totalavg85 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hhhh= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade16) as totalavg86 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var iiii= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade17) as totalavg87 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jjjj= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade18) as totalavg88 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kkkk= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade19) as totalavg89 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var llll= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade20) as totalavg90 FROM `fourthyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
