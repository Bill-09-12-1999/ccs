...
<div class="links">
	<a href="facultyitrog2.php" id="active">IT</a>
	<a href="facultyisrog2.php">IS</a>
</div>
...
<br><br><br><br>
	<div class="header">
	<form action="facultyitrog2copy.php" method="POST">
	...
	<label>
		...
		border-left-color: white;
		border-right-color: white;">/
		<input type="text" name="section" value="II - " id="section"
		style="width: 10%;
		border-style: solid;
		border: 1px solid black;
		border-top-color: white;
	...
	<label>
		...
		border-left-color: white;
		border-right-color: white;">/
		<input type="text" name="section2" value="II - " id="section"
		style="width: 10%;
		border-style: solid;
		border: 1px solid black;
		border-top-color: white;
