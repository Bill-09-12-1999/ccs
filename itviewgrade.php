  ...
  <body>
    ...
    $result= mysqli_fetch_array($results);
     ...
     <div class="regis">
        ...
        <center><a href="studentrogrecords.php"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-circle-fill back" viewBox="0 0 16 16">
