...
<div class="links">
	<a href="facultyitviewrog1.php">IT</a>
	<a href="facultyitviewrogis1.php" id="active">IS</a>
</div>
<div style="background: rgba(0,0,0,0.9);width:100%;height:100%;position:fixed;top:0;left:0;overflow:auto;display:none;" id="bg">
	...
	<form action="messageiscopy1.php" method="POST">
	<table>
			<thead>
				<tr>
	...
	<table border="1" cellspacing="0">
		...
		<?php
        $i = 1;
        $rows = mysqli_query($link, "SELECT * FROM firstyearis ORDER BY name ASC");
      	?>
	    <?php
	        foreach($rows as $row) :
	    ?>
		...
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade` LIKE '1.00' OR `grade` LIKE '1.0' OR `grade` LIKE '1.25' OR `grade` LIKE '1.50' OR `grade` LIKE '1.75' OR `grade` LIKE '2.00' OR `grade` LIKE '2.0' OR `grade` LIKE '2.25'  OR `grade` LIKE '2.50'  OR `grade` LIKE '2.75'  OR `grade` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade` LIKE '4.00' OR `grade` LIKE '4.0' OR `grade` LIKE '5.00' OR `grade` LIKE '5.0' ";
				      $results = mysqli_query($link,$query);
				...
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade`='INC'";
				      $results = mysqli_query($link,$query);
				...
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade`='IP'";
				      $results = mysqli_query($link,$query);
				...
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade2` LIKE '1.00' OR `grade` LIKE '1.0' OR `grade2` LIKE '1.25' OR `grade2` LIKE '1.50' OR `grade2` LIKE '1.75' OR `grade2` LIKE '2.00' OR `grade` LIKE '2.0' OR `grade2` LIKE '2.25'  OR `grade2` LIKE '2.50'  OR `grade2` LIKE '2.75'  OR `grade2` LIKE '3.0' OR `grade` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade2` LIKE '4.0' OR `grade` LIKE '4.00' OR `grade2` LIKE '5.0' OR `grade` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade2`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade2`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade2`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade3` LIKE '1.0' OR `grade` LIKE '1.00' OR `grade3` LIKE '1.25' OR `grade3` LIKE '1.50' OR `grade3` LIKE '1.75' OR `grade3` LIKE '2.0' OR `grade3` LIKE '2.25'  OR `grade3` LIKE '2.50'  OR `grade3` LIKE '2.75'  OR `grade3` LIKE '3.0' OR `grade` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade3` LIKE '4.0' OR `grade` LIKE '4.00' OR `grade3` LIKE '5.0' OR `grade` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade3`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade3`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade3`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade4` LIKE '1.0' OR `grade` LIKE '1.00' OR `grade4` LIKE '1.25' OR `grade4` LIKE '1.50' OR `grade4` LIKE '1.75' OR `grade4` LIKE '2.0' OR `grade4` LIKE '2.25'  OR `grade4` LIKE '2.50'  OR `grade4` LIKE '2.75'  OR `grade4` LIKE '3.0' OR `grade` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade4` LIKE '4.0' OR `grade` LIKE '4.00' OR `grade4` LIKE '5.0' OR `grade` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade4`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade4`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade4`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade5` LIKE '1.0' OR `grade5` LIKE '1.00' OR `grade5` LIKE '1.25' OR `grade5` LIKE '1.50' OR `grade5` LIKE '1.75' OR `grade5` LIKE '2.0' OR `grade5` LIKE '2.00' OR `grade5` LIKE '2.25'  OR `grade5` LIKE '2.50'  OR `grade5` LIKE '2.75'  OR `grade5` LIKE '3.0' OR `grade5` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade5` LIKE '4.0' OR `grade5` LIKE '4.00' OR `grade5` LIKE '5.0' OR `grade5` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade5`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade5`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade5`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade6` LIKE '1.0' OR `grade6` LIKE '1.00' OR `grade6` LIKE '1.25' OR `grade6` LIKE '1.50' OR `grade6` LIKE '1.75' OR `grade6` LIKE '2.0' OR `grade6` LIKE '2.00' OR `grade6` LIKE '2.25'  OR `grade6` LIKE '2.50'  OR `grade6` LIKE '2.75'  OR `grade6` LIKE '3.0' OR `grade6` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade6` LIKE '4.0' OR `grade6` LIKE '4.00' OR `grade6` LIKE '5.0' OR `grade6` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade6`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade6`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade6`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade7` LIKE '1.0' OR `grade7` LIKE '1.00' OR `grade7` LIKE '1.25' OR `grade7` LIKE '1.50' OR `grade7` LIKE '1.75' OR `grade7` LIKE '2.0' OR `grade7` LIKE '2.00' OR `grade7` LIKE '2.25'  OR `grade7` LIKE '2.50'  OR `grade7` LIKE '2.75'  OR `grade7` LIKE '3.0' OR `grade7` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade7` LIKE '4.0' OR `grade7` LIKE '4.00' OR `grade7` LIKE '5.0' OR `grade7` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade7`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade7`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade7`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade8` LIKE '1.0' OR `grade8` LIKE '1.00' OR `grade8` LIKE '1.25' OR `grade8` LIKE '1.50' OR `grade8` LIKE '1.75' OR `grade8` LIKE '2.0' OR `grade8` LIKE '2.00'OR `grade8` LIKE '2.25'  OR `grade8` LIKE '2.50'  OR `grade8` LIKE '2.75'  OR `grade8` LIKE '3.0' OR `grade8` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade8` LIKE '4.0' OR `grade8` LIKE '4.00' OR `grade8` LIKE '5.0' OR `grade8` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade8`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade8`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade8`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade9` LIKE '1.0' OR `grade9` LIKE '1.00' OR `grade9` LIKE '1.25' OR `grade9` LIKE '1.50' OR `grade9` LIKE '1.75' OR `grade9` LIKE '2.0' OR `grade9` LIKE '2.00'OR `grade9` LIKE '2.25'  OR `grade9` LIKE '2.50'  OR `grade9` LIKE '2.75'  OR `grade9` LIKE '3.0' OR `grade9` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade9` LIKE '4.0' OR `grade9` LIKE '4.00' OR `grade9` LIKE '5.0' OR `grade9` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade9`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade9`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade9`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade10` LIKE '1.0' OR `grade10` LIKE '1.00' OR `grade10` LIKE '1.25' OR `grade10` LIKE '1.50' OR `grade10` LIKE '1.75' OR `grade10` LIKE '2.0' OR `grade10` LIKE '2.00'OR `grade10` LIKE '2.25'  OR `grade10` LIKE '2.50'  OR `grade10` LIKE '2.75'  OR `grade10` LIKE '3.0' OR `grade10` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade10` LIKE '4.0' OR `grade10` LIKE '4.00' OR `grade10` LIKE '5.0' OR `grade10` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade10`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade10`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade10`='DROPPED'";
				      $results = mysqli_query($link,$query);
 ...
 <div class="header">
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade11` LIKE '1.0' OR `grade11` LIKE '1.00' OR `grade11` LIKE '1.25' OR `grade11` LIKE '1.50' OR `grade11` LIKE '1.75' OR `grade11` LIKE '2.0' OR `grade11` LIKE '2.00'OR `grade11` LIKE '2.25'  OR `grade11` LIKE '2.50'  OR `grade11` LIKE '2.75'  OR `grade11` LIKE '3.0' OR `grade11` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade11` LIKE '4.0' OR `grade11` LIKE '4.00' OR `grade11` LIKE '5.0' OR `grade11` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade11`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade11`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade11`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade12` LIKE '1.0' OR `grade12` LIKE '1.00' OR `grade12` LIKE '1.25' OR `grade12` LIKE '1.50' OR `grade12` LIKE '1.75' OR `grade12` LIKE '2.0' OR `grade12` LIKE '2.00'OR `grade12` LIKE '2.25'  OR `grade12` LIKE '2.50'  OR `grade12` LIKE '2.75'  OR `grade12` LIKE '3.0' OR `grade12` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade12` LIKE '4.0' OR `grade12` LIKE '4.00' OR `grade12` LIKE '5.0' OR `grade12` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade12`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade12`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade12`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade13` LIKE '1.0' OR `grade13` LIKE '1.00' OR `grade13` LIKE '1.25' OR `grade13` LIKE '1.50' OR `grade13` LIKE '1.75' OR `grade13` LIKE '2.0' OR `grade13` LIKE '2.00'OR `grade13` LIKE '2.25'  OR `grade13` LIKE '2.50'  OR `grade13` LIKE '2.75'  OR `grade13` LIKE '3.0' OR `grade13` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade13` LIKE '4.0' OR `grade13` LIKE '4.00' OR `grade13` LIKE '5.0' OR `grade13` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade13`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade13`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade13`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade14` LIKE '1.0' OR `grade14` LIKE '1.00' OR `grade14` LIKE '1.25' OR `grade14` LIKE '1.50' OR `grade14` LIKE '1.75' OR `grade14` LIKE '2.0' OR `grade14` LIKE '2.00'OR `grade14` LIKE '2.25'  OR `grade14` LIKE '2.50'  OR `grade14` LIKE '2.75'  OR `grade14` LIKE '3.0' OR `grade14` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade14` LIKE '4.0' OR `grade14` LIKE '4.00' OR `grade14` LIKE '5.0' OR `grade14` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade14`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade14`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade14`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade15` LIKE '1.0' OR `grade15` LIKE '1.00' OR `grade15` LIKE '1.25' OR `grade15` LIKE '1.50' OR `grade15` LIKE '1.75' OR `grade15` LIKE '2.0' OR `grade15` LIKE '2.00'OR `grade15` LIKE '2.25'  OR `grade15` LIKE '2.50'  OR `grade15` LIKE '2.75'  OR `grade15` LIKE '3.0' OR `grade15` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade15` LIKE '4.0' OR `grade15` LIKE '4.00' OR `grade15` LIKE '5.0' OR `grade15` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade15`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade15`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade15`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade16` LIKE '1.0' OR `grade16` LIKE '1.00' OR `grade16` LIKE '1.25' OR `grade16` LIKE '1.50' OR `grade16` LIKE '1.75' OR `grade16` LIKE '2.0' OR `grade16` LIKE '2.00'OR `grade16` LIKE '2.25'  OR `grade16` LIKE '2.50'  OR `grade16` LIKE '2.75'  OR `grade16` LIKE '3.0' OR `grade16` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade16` LIKE '4.0' OR `grade16` LIKE '4.00' OR `grade16` LIKE '5.0' OR `grade16` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade16`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade16`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade16`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade17` LIKE '1.0' OR `grade17` LIKE '1.00' OR `grade17` LIKE '1.25' OR `grade17` LIKE '1.50' OR `grade17` LIKE '1.75' OR `grade17` LIKE '2.0' OR `grade17` LIKE '2.00'OR `grade17` LIKE '2.25'  OR `grade17` LIKE '2.50'  OR `grade17` LIKE '2.75'  OR `grade17` LIKE '3.0' OR `grade17` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade17` LIKE '4.0' OR `grade17` LIKE '4.00' OR `grade17` LIKE '5.0' OR `grade17` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade17`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade17`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade17`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade18` LIKE '1.0' OR `grade18` LIKE '1.00' OR `grade18` LIKE '1.25' OR `grade18` LIKE '1.50' OR `grade18` LIKE '1.75' OR `grade18` LIKE '2.0' OR `grade18` LIKE '2.00'OR `grade18` LIKE '2.25'  OR `grade18` LIKE '2.50'  OR `grade18` LIKE '2.75'  OR `grade18` LIKE '3.0' OR `grade18` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade18` LIKE '4.0' OR `grade18` LIKE '4.00' OR `grade18` LIKE '5.0' OR `grade18` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade18`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade18`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade18`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade19` LIKE '1.0' OR `grade19` LIKE '1.00' OR `grade19` LIKE '1.25' OR `grade19` LIKE '1.50' OR `grade19` LIKE '1.75' OR `grade19` LIKE '2.0' OR `grade19` LIKE '2.00'OR `grade19` LIKE '2.25'  OR `grade19` LIKE '2.50'  OR `grade19` LIKE '2.75'  OR `grade19` LIKE '3.0' OR `grade19` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade19` LIKE '4.0' OR `grade19` LIKE '4.00' OR `grade19` LIKE '5.0' OR `grade19` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade19`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade19`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade19`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade20` LIKE '1.0' OR `grade20` LIKE '1.00' OR `grade20` LIKE '1.25' OR `grade20` LIKE '1.50' OR `grade20` LIKE '1.75' OR `grade20` LIKE '2.0' OR `grade20` LIKE '2.00'OR `grade20` LIKE '2.25'  OR `grade20` LIKE '2.50'  OR `grade20` LIKE '2.75'  OR `grade20` LIKE '3.0' OR `grade20` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade20` LIKE '4.0' OR `grade20` LIKE '4.00' OR `grade20` LIKE '5.0' OR `grade20` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade20`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade20`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `firstyearis` WHERE `grade20`='DROPPED'";
				      $results = mysqli_query($link,$query);
