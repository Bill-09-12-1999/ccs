...
<p style="color:white;background:black;width:100%;text-align: center;font-family: Arial Black;padding:30px 0 30px 0;font-size: 30px; text-shadow: 3px 3px 0 skyblue;"><marquee>MID YEAR</marquee></p>
<br><br>



<div class="links">
	<a href="facultyitviewrog3_1.php">IT WEB</a>
	<a href="facultyitviewrog3_1net.php" id="active">IT NET</a>
	<a href="facultyitviewrog3_1is.php">IS</a>
</div>
<div style="background: rgba(0,0,0,0.9);width:100%;height:100%;position:fixed;top:0;left:0;overflow:auto;display:none;" id="bg">
	...
	<form action="messagenetcopy3_1.php" method="POST">
	<table>
			<thead>
				<tr>
...
<br><br><br><br>
	...
	<table border="1" cellspacing="0">
		...
		<?php
        $i = 1;
        $rows = mysqli_query($link, "SELECT * FROM midyearnet ORDER BY name ASC");
      	?>
	    <?php
	        foreach($rows as $row) :
	    ?>
		...
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade` LIKE '1.00' OR `grade` LIKE '1.0' OR `grade` LIKE '1.25' OR `grade` LIKE '1.50' OR `grade` LIKE '1.75' OR `grade` LIKE '2.00' OR `grade` LIKE '2.0' OR `grade` LIKE '2.25'  OR `grade` LIKE '2.50'  OR `grade` LIKE '2.75'  OR `grade` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade` LIKE '4.00' OR `grade` LIKE '4.0' OR `grade` LIKE '5.00' OR `grade` LIKE '5.0' ";
				      $results = mysqli_query($link,$query);
				...
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade`='INC'";
				      $results = mysqli_query($link,$query);
				...
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade`='IP'";
				      $results = mysqli_query($link,$query);
				...
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade2` LIKE '1.00' OR `grade` LIKE '1.0' OR `grade2` LIKE '1.25' OR `grade2` LIKE '1.50' OR `grade2` LIKE '1.75' OR `grade2` LIKE '2.00' OR `grade` LIKE '2.0' OR `grade2` LIKE '2.25'  OR `grade2` LIKE '2.50'  OR `grade2` LIKE '2.75'  OR `grade2` LIKE '3.0' OR `grade` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade2` LIKE '4.0' OR `grade` LIKE '4.00' OR `grade2` LIKE '5.0' OR `grade` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade2`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade2`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade2`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade3` LIKE '1.0' OR `grade` LIKE '1.00' OR `grade3` LIKE '1.25' OR `grade3` LIKE '1.50' OR `grade3` LIKE '1.75' OR `grade3` LIKE '2.0' OR `grade3` LIKE '2.25'  OR `grade3` LIKE '2.50'  OR `grade3` LIKE '2.75'  OR `grade3` LIKE '3.0' OR `grade` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade3` LIKE '4.0' OR `grade` LIKE '4.00' OR `grade3` LIKE '5.0' OR `grade` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade3`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade3`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade3`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade4` LIKE '1.0' OR `grade` LIKE '1.00' OR `grade4` LIKE '1.25' OR `grade4` LIKE '1.50' OR `grade4` LIKE '1.75' OR `grade4` LIKE '2.0' OR `grade4` LIKE '2.25'  OR `grade4` LIKE '2.50'  OR `grade4` LIKE '2.75'  OR `grade4` LIKE '3.0' OR `grade` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade4` LIKE '4.0' OR `grade` LIKE '4.00' OR `grade4` LIKE '5.0' OR `grade` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade4`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade4`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade4`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade5` LIKE '1.0' OR `grade5` LIKE '1.00' OR `grade5` LIKE '1.25' OR `grade5` LIKE '1.50' OR `grade5` LIKE '1.75' OR `grade5` LIKE '2.0' OR `grade5` LIKE '2.00' OR `grade5` LIKE '2.25'  OR `grade5` LIKE '2.50'  OR `grade5` LIKE '2.75'  OR `grade5` LIKE '3.0' OR `grade5` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade5` LIKE '4.0' OR `grade5` LIKE '4.00' OR `grade5` LIKE '5.0' OR `grade5` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade5`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade5`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade5`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade6` LIKE '1.0' OR `grade6` LIKE '1.00' OR `grade6` LIKE '1.25' OR `grade6` LIKE '1.50' OR `grade6` LIKE '1.75' OR `grade6` LIKE '2.0' OR `grade6` LIKE '2.00' OR `grade6` LIKE '2.25'  OR `grade6` LIKE '2.50'  OR `grade6` LIKE '2.75'  OR `grade6` LIKE '3.0' OR `grade6` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade6` LIKE '4.0' OR `grade6` LIKE '4.00' OR `grade6` LIKE '5.0' OR `grade6` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade6`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade6`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade6`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade7` LIKE '1.0' OR `grade7` LIKE '1.00' OR `grade7` LIKE '1.25' OR `grade7` LIKE '1.50' OR `grade7` LIKE '1.75' OR `grade7` LIKE '2.0' OR `grade7` LIKE '2.00' OR `grade7` LIKE '2.25'  OR `grade7` LIKE '2.50'  OR `grade7` LIKE '2.75'  OR `grade7` LIKE '3.0' OR `grade7` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade7` LIKE '4.0' OR `grade7` LIKE '4.00' OR `grade7` LIKE '5.0' OR `grade7` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade7`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade7`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade7`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade8` LIKE '1.0' OR `grade8` LIKE '1.00' OR `grade8` LIKE '1.25' OR `grade8` LIKE '1.50' OR `grade8` LIKE '1.75' OR `grade8` LIKE '2.0' OR `grade8` LIKE '2.00'OR `grade8` LIKE '2.25'  OR `grade8` LIKE '2.50'  OR `grade8` LIKE '2.75'  OR `grade8` LIKE '3.0' OR `grade8` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade8` LIKE '4.0' OR `grade8` LIKE '4.00' OR `grade8` LIKE '5.0' OR `grade8` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade8`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade8`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade8`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade9` LIKE '1.0' OR `grade9` LIKE '1.00' OR `grade9` LIKE '1.25' OR `grade9` LIKE '1.50' OR `grade9` LIKE '1.75' OR `grade9` LIKE '2.0' OR `grade9` LIKE '2.00'OR `grade9` LIKE '2.25'  OR `grade9` LIKE '2.50'  OR `grade9` LIKE '2.75'  OR `grade9` LIKE '3.0' OR `grade9` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade9` LIKE '4.0' OR `grade9` LIKE '4.00' OR `grade9` LIKE '5.0' OR `grade9` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade9`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade9`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade9`='DROPPED'";
				      $results = mysqli_query($link,$query);
	...
	<table border="1" cellspacing="0">
		<tr>
			...
			<td style="width:40%; cursor:default;">
				No. of Student Passed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade10` LIKE '1.0' OR `grade10` LIKE '1.00' OR `grade10` LIKE '1.25' OR `grade10` LIKE '1.50' OR `grade10` LIKE '1.75' OR `grade10` LIKE '2.0' OR `grade10` LIKE '2.00'OR `grade10` LIKE '2.25'  OR `grade10` LIKE '2.50'  OR `grade10` LIKE '2.75'  OR `grade10` LIKE '3.0' OR `grade10` LIKE '3.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student failed: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade10` LIKE '4.0' OR `grade10` LIKE '4.00' OR `grade10` LIKE '5.0' OR `grade10` LIKE '5.00'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with INC: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade10`='INC'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student with IP: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade10`='IP'";
				      $results = mysqli_query($link,$query);
				...
				?><br>
				No. of Student Dropped: <?php
      				  $query = "SELECT * FROM `midyearnet` WHERE `grade10`='DROPPED'";
				      $results = mysqli_query($link,$query);
