  ...
  <body>
    <div id="mainbox" onclick="openfunction()">&#9776;</div>
      ...
      <div class="login-box">
          ...
          <form action="loginis.php" method="POST">
            <div class="form-group">
              <input type="text" name="studentid" class="form-control" placeholder="Enter Your Student ID #" required>
            </div><br>
          ...
          <center><a href="isreg.php" style="color:black;font-family: Arial black;font-size: 20px;">Register Here</a></center>
        </div>
      </div>
    </div>
  <div class="bg"></div>
  <div class="BSIS">
    <a href="BSISstudent.php">BSIS LOGIN FORM</a>
  </div>
  <div class="BSIT">
    <a href="index.php">BSIT LOGIN FORM</a>
  </div>
        <script>
