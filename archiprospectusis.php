...
<?php
						require'conn.php';
						$query=mysqli_query($link, "SELECT * FROM `archiveis`") or die(mysqli_error());
						while($fetch=mysqli_fetch_array($query)){
					?>

    <a href="unarchiving3.php?name=<?php echo $fetch['name']?>" id="archi1">Un-Archive Records</a>
    			<?php
						}
	?>
	...
	<?php
    $query = "SELECT * FROM `archiveis` WHERE `name`= '$name'";
	...
	<div class="body">
		...
		<?php
		    $query = "SELECT * FROM `archive2is` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
		...
		<?php
		    $query = "SELECT * FROM `archive3is` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
		...
		<?php
		    $query = "SELECT * FROM `archive3_1is` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
		...
		<?php
		    $query = "SELECT * FROM `archive4is` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
...
<script>
	var a= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var b= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var c= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var d= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var e= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var f= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var g= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var h= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var i= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var j= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var k= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var l= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var m= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var n= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var o= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var p= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var q= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var r= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var s= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var t= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `archiveis` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var u= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var v= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var w= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var x= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var y= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var z= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aa= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bb= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var cc= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var dd= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ee= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ff= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var gg= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hh= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ii= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jj= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kk= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ll= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var mm= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var nn= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `archive2is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var oo= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var pp= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var qq= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var rr= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ss= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var tt= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var uu= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var vv= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ww= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var xx= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var yy= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var zz= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aaa= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bbb= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ccc= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ddd= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var eee= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var fff= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ggg= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hhh= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `archive3is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var iii= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jjj= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kkk= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var lll= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var mmm= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var nnn= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ooo= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ppp= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var qqq= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var rrr= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `archive3_1is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var sss= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ttt= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var uuu= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var vvv= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var www= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var xxx= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var yyy= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var zzz= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aaaa= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bbbb= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var cccc= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var dddd= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var eeee= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ffff= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var gggg= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hhhh= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var iiii= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jjjj= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kkkk= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var llll= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `archive4is` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
