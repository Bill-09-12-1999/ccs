...
<div class="links">
	...
	<a href="facultyitnetrog4.php" id="active">IT NET</a>
	<a href="facultyisrog4.php">IS</a>
</div>
...
<br><br><br><br>
	<div class="header">
	<form action="facultyitnetrog4copy.php" method="POST">
	...
	<label>
		...
		border-left-color: white;
		border-right-color: white;">/
		<input type="text" name="section" value="IV - " id="section"
		style="width: 10%;
		border-style: solid;
		border: 1px solid black;
		border-top-color: white;
	...
	<label>
		...
		border-left-color: white;
		border-right-color: white;">/
		<input type="text" name="section2" value="IV - " id="section"
		style="width: 10%;
		border-style: solid;
		border: 1px solid black;
		border-top-color: white;
