  ...
  <body>
    <div class="sidemenu">
      <img src="images/logo.png"></img>
        ...
        <ul>
          <a href="studgrade2.php"><li class="l1">Your Grades</li></a>
        </ul>
        <ul>
          <a href="upstudgrade2.php"><li class="l2">Updated Grade</li></a>
        </ul>
        <ul>
    ...
    <?php
    $query = "SELECT * FROM `isgrade` WHERE `studentid`= '$studentid'";
