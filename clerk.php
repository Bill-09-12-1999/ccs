  ...
  <body>
    <div id="mainbox" onclick="openfunction()">&#9776;</div>
        <div id="menu" class="sidemenu">
          ...
          <ul>
            <li><a href="index.php" class="admin">
      ...
      <div class="login-box">
          ...
          <h1 style="text-align:center; font-family:Arial Black; color:white; letter-spacing:4px;text-shadow: 2px 2px 5px black;">HELLO CLERK <br> <p style="font-family: arial;font-size: 20px;letter-spacing: 0;">Login Here </p></h1><br><br>
          <form action="clerkprog.php" method="POST">
