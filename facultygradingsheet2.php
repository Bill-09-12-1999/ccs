...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Faculty IS ROG Creator</title>
    <style>
    body{
      margin:0;
      padding:0;
  ...
  <body>
    ...
    <form action="facultygradingsheet2copy.php" method="POST">
    <div style="background: white;padding:20px; font-family: arial; width:70%;margin-top:1.4%;margin-left: 17%;" class="rog">
    	...
    	<h3>
    		Name of student:<input type="text" name="name" style="border-style: solid;border: 1px solid black;border-top-color: white;border-left-color: white;border-right-color:white;width:40%;margin-right:12%;margin-left:2%;">
