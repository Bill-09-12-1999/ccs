...
<html lang="en" dir="ltr">
  <head>
    ...
    *{
    ...
    body{
      margin:0px;
      padding:0px;
      background:linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url('images/ccs.jpg');
  ...
  <body>
    <form action="clerkmsgtouser.php" method="POST">
    <div style="position:fixed; top:0;right:0;z-index: 1;width:200px;margin-right: 5%;margin-top: 3%;color:white;font-family: arial; font-size:20px; text-shadow:1px 1px 10px black;" class="messagebox">
      <h4>Please Enter a message if the student had an IP Grade...<br><br>Please specify the subject<br><br>example message: You have IP on IT 164, IT 101, etc...</h4><br>
      <input type="text" name="studentid" placeholder="Enter Student No." id="input" required><br><br>
      <textarea name="message" placeholder="Enter Your Message Here..." id="textarea" required></textarea><br><br>
      date today:<br>
      <input type="date" name="date" id="input" required><br><br>
    ...
    <?php
    $query = "SELECT * FROM `registrarisrecords` WHERE `id`= '$id'";
    ...
    $result= mysqli_fetch_array($results);
     ...
     <div class="regis">
        ...
        <center><a href="clerksavedisstudentrecords.php"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-circle-fill back" viewBox="0 0 16 16">
