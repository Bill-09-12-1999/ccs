  ...
  <body>
    ...
    <div class="formmsgtoadmin" id="form">
      ...
      ?>
          ...
          <p>
            Hi! This is
            <b style="text-transform: capitalize;"><?php echo $result['sender'];?></b> of Ilocos Sur Polytechnic State College. I would like to request that <b style="text-transform: capitalize;"><?php echo $result['student'];?></b> had been completed/accomplished the documents needed on updating his/her IP Grade on the Course <b style="text-transform: capitalize;"><?php echo $result['courseno'];?></b>, with the Descriptive Title of <b style="text-transform: capitalize;"><?php echo $result['des'];?>.</b><br><br><br><br>
