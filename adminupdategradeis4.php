...
<body>
	...
	<p style="color:white;background:black;width:100%;text-align: center;font-family: Arial Black;padding:30px 0 30px 0;font-size: 30px; text-shadow: 3px 3px 0 skyblue;"><marquee>MID YEAR IS</marquee></p>
	<br><br><br>
<br><br>
...
<br><br><br><br>
	<div class="header">
	<form action="adminupdategradeis4copy.php" method="POST">
