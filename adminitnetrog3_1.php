...
<div class="links">
	<a href="adminitrog3_1.php">IT WEB</a>
	<a href="adminitnetrog3_1.php" id="active">IT NET</a>
	<a href="adminisrog3_1.php">IS</a>
...
<div style="background: rgba(0,0,0,0.9);width:100%;height:100%;position:fixed;top:0;left:0;overflow:auto;display:none;" id="bg">
	...
	<form action="adminmessage3_1copynet.php" method="POST">
	<table>
			<thead>
				<tr>
