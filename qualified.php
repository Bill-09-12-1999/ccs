  ...
  <body>
    <div class="sidemenu">
      ...
      <img src="images/ccs.jpg" id="img2"></img>
        ...
        <ul>
          <a href="admingradereports.php"><li class="l2"> Admin ROG</li></a>
        </ul>
    ...
    <center><div class="table">
      <table>
        <thead>
                <caption>Dean's Lister Students</caption>
        ...
        <tbody>
                <?php
                $query = 'SELECT * FROM `deanslister` ORDER BY name ASC';
            ...
            <tr>
                ...
                <td><?php echo $result['ave'];?></td>
                <td><a href="deanlisteritweb.php?name=<?php echo $result['name'];?>" id="print">See Records</a></td>
            </tr>
            <?php
      }
      } else {
        ?>
        <tr>
          <td colspan="9">No Data Found on IT WEB & IT NET!</td>
        </tr>
      <?php } ?>
      ...
      <table>
        <tbody>
                <?php
                $query = 'SELECT * FROM `deanslisteris` ORDER BY name ASC';
                $results=mysqli_query($link,$query);
                if (mysqli_num_rows($results)>=1) {
                while($result=mysqli_fetch_array($results)){
                ?>
            <tr>
                ...
                <td><?php echo $result['studentid'];?></td>
                <td><?php echo $result['ave'];?></td>
                <td><a href="deanlisteris.php?name=<?php echo $result['name'];?>" id="print">See Records</a></td>
            </tr>
            <?php
      }
      } else {
