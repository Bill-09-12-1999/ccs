...
<html lang="en" dir="ltr">
    ...
    <style>
        *{
        ...
        body{
          margin:0;
          padding:0;
          background:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url('images/ad.jpeg');
  ...
  <body>
    ...
    <form action="upclerkiseditaddgrade.php" method="POST">
    <div class="container">
      <div class="login-box">
      <div class="row">
    ...
    <input name="sem9" value ="<?php echo $result['sem9'];?>" style="width:60px;"></input> Semester, AY <input name="AY9" value ="<?php echo $result['AY9'];?>" style="width:120px;"></input> Year & Section: <input name="section9" value ="<?php echo $result['section9'];?>" style="width:120px;"><br><br>
      ...
      <tr style="text-align: center;">
          ...
          <td><input name="grade90" value ="<?php echo $result['grade90'];?>" style="font-family:arial; width:20%;"></input></td>
              ...
              <a href="clerksavedisstudentrecords.php" style="text-decoration:none; padding:10px; padding-left: 50px;padding-right: 50px;background:blue;
