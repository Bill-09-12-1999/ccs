  ...
  <body>
    ...
    <div class="sidemenu">
      ...
      <img src="images/ccs.jpg" id="img2"></img>
        ...
        <ul>
          <a href="studentgradeis.php"><li class="l1">Your Grades</li></a>
        </ul>
        <ul>
    ...
    <?php
    $query = "SELECT * FROM `firstyearis` WHERE `studentid`= '$studentid'";
    ...
    <div class="grade">
     ...
     <table cellspacing="0">
      ...
      <?php
       ...
       if($result['grade']==0.0 AND $result['grade2']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
      ";} else{ include './download/ist1is.php';}?>
   ...
   <div class="in">
     ...
     <?php
      ...
      if($result['grade11']==0.0 AND $result['grade12']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
     ";} else{ include './download/ist2is.php';}?>
   ...
   <?php
    $query = "SELECT * FROM `secondyearis` WHERE `studentid`= '$studentid'";
    $results = mysqli_query($link,$query);
    $result= mysqli_fetch_array($results);
     ?>
  ...
  <div class="in">
     ...
     <table cellspacing="0">
      ...
      <?php
       ...
       if($result['grade']==0.0 AND $result['grade2']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
      ";} else{ include './download/sec1is.php';}?>
   ...
   <div class="in">
     ...
     <?php
      ...
      if($result['grade11']==0.0 AND $result['grade12']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
     ";} else{ include './download/sec2is.php';}?>
   ...
   <?php
      $query = "SELECT * FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
      $result= mysqli_fetch_array($results);
  ?>
  ...
  <div class="in">
     ...
     <table cellspacing="0">
      ...
      <?php
       ...
       if($result['grade']==0.0 AND $result['grade2']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
      ";} else{ include './download/thir1is.php';}?>
   ...
   <div class="in">
     ...
     <?php
      ...
      if($result['grade11']==0.0 AND $result['grade12']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
     ";} else{ include './download/this2is.php';}?>
...
<?php
    $query = "SELECT * FROM `midyearis` WHERE `studentid`= '$studentid'";
    $results = mysqli_query($link,$query);
    $result= mysqli_fetch_array($results);
     ?>
  ...
  <div class="in">
     ...
     <table cellspacing="0">
      ...
      <?php
       ...
       if($result['grade']==0.0 AND $result['grade2']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
      ";} else{ include './download/midis.php';}?>
   ...
   <?php
    $query = "SELECT * FROM `fourthyearis` WHERE `studentid`= '$studentid'";
    $results = mysqli_query($link,$query);
    $result= mysqli_fetch_array($results);
     ?>
  ...
  <div class="in">
     ...
     <table cellspacing="0">
      ...
      <?php
       ...
       if($result['grade']==0.0 AND $result['grade2']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
      ";} else{ include './download/for1is.php';}?>
   ...
   <?php
    ...
    if($result['grade11']==0.0 AND $result['grade12']==0.0){echo "<button style='background:linear-gradient(#E989AF,#FD8386); color: black; padding: 15px 32px; font-size: 16px; border:none;border-radius:10px;'>Unable to Download this Record!!!</button>
   ";} else{ include './download/for2is.php';}?>
...
<script>
  var a= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avga= parseFloat(
    <?php
      $query = "SELECT sum(grade) as totalavg FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var b= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgb= parseFloat(
    <?php
      $query = "SELECT sum(grade2) as totalavg2 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var c= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgc= parseFloat(
    <?php
      $query = "SELECT sum(grade3) as totalavg3 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var d= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgd= parseFloat(
    <?php
      $query = "SELECT sum(grade4) as totalavg4 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var e= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avge= parseFloat(
    <?php
      $query = "SELECT sum(grade5) as totalavg5 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var f= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgf= parseFloat(
    <?php
      $query = "SELECT sum(grade6) as totalavg6 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var g= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgg= parseFloat(
    <?php
      $query = "SELECT sum(grade7) as totalavg7 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var h= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgh= parseFloat(
    <?php
      $query = "SELECT sum(grade8) as totalavg8 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var i= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgi= parseFloat(
    <?php
      $query = "SELECT sum(grade9) as totalavg9 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var j= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgj= parseFloat(
    <?php
      $query = "SELECT sum(grade10) as totalavg10 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var k= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgk= parseFloat(
    <?php
      $query = "SELECT sum(grade11) as totalavg11 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var l= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgl= parseFloat(
    <?php
      $query = "SELECT sum(grade12) as totalavg12 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var m= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgm= parseFloat(
    <?php
      $query = "SELECT sum(grade13) as totalavg13 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var n= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgn= parseFloat(
    <?php
      $query = "SELECT sum(grade14) as totalavg14 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var o= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgo= parseFloat(
    <?php
      $query = "SELECT sum(grade15) as totalavg15 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var p= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgp= parseFloat(
    <?php
      $query = "SELECT sum(grade16) as totalavg16 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var q= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgq= parseFloat(
    <?php
      $query = "SELECT sum(grade17) as totalavg17 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var r= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgr= parseFloat(
    <?php
      $query = "SELECT sum(grade18) as totalavg18 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var s= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgs= parseFloat(
    <?php
      $query = "SELECT sum(grade19) as totalavg19 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var t= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgt= parseFloat(
    <?php
      $query = "SELECT sum(grade20) as totalavg20 FROM `firstyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var u= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avga2= parseFloat(
    <?php
      $query = "SELECT sum(grade) as totalavg21 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var v= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgb2= parseFloat(
    <?php
      $query = "SELECT sum(grade2) as totalavg22 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var w= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgc2= parseFloat(
    <?php
      $query = "SELECT sum(grade3) as totalavg23 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var x= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgd2= parseFloat(
    <?php
      $query = "SELECT sum(grade4) as totalavg24 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var y= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avge2= parseFloat(
    <?php
      $query = "SELECT sum(grade5) as totalavg25 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var z= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgf2= parseFloat(
    <?php
      $query = "SELECT sum(grade6) as totalavg26 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var aa= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgg2= parseFloat(
    <?php
      $query = "SELECT sum(grade7) as totalavg27 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var bb= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgh2= parseFloat(
    <?php
      $query = "SELECT sum(grade8) as totalavg28 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var cc= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgi2= parseFloat(
    <?php
      $query = "SELECT sum(grade9) as totalavg29 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var dd= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgj2= parseFloat(
    <?php
      $query = "SELECT sum(grade10) as totalavg30 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ee= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgk2= parseFloat(
    <?php
      $query = "SELECT sum(grade11) as totalavg31 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ff= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgl2= parseFloat(
    <?php
      $query = "SELECT sum(grade12) as totalavg32 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var gg= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgm2= parseFloat(
    <?php
      $query = "SELECT sum(grade13) as totalavg33 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var hh= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgn2= parseFloat(
    <?php
      $query = "SELECT sum(grade14) as totalavg34 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ii= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgo2= parseFloat(
    <?php
      $query = "SELECT sum(grade15) as totalavg35 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var jj= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgp2= parseFloat(
    <?php
      $query = "SELECT sum(grade16) as totalavg36 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var kk= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgq2= parseFloat(
    <?php
      $query = "SELECT sum(grade17) as totalavg37 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ll= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgr2= parseFloat(
    <?php
      $query = "SELECT sum(grade18) as totalavg38 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var mm= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgs2= parseFloat(
    <?php
      $query = "SELECT sum(grade19) as totalavg39 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var nn= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgt2= parseFloat(
    <?php
      $query = "SELECT sum(grade20) as totalavg40 FROM `secondyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var oo= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avga3= parseFloat(
    <?php
      $query = "SELECT sum(grade) as totalavg41 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var pp= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgb3= parseFloat(
    <?php
      $query = "SELECT sum(grade2) as totalavg42 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var qq= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgc3= parseFloat(
    <?php
      $query = "SELECT sum(grade3) as totalavg43 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var rr= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgd3= parseFloat(
    <?php
      $query = "SELECT sum(grade4) as totalavg44 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ss= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avge3= parseFloat(
    <?php
      $query = "SELECT sum(grade5) as totalavg45 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var tt= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgf3= parseFloat(
    <?php
      $query = "SELECT sum(grade6) as totalavg46 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var uu= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgg3= parseFloat(
    <?php
      $query = "SELECT sum(grade7) as totalavg47 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var vv= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgh3= parseFloat(
    <?php
      $query = "SELECT sum(grade8) as totalavg48 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ww= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgi3= parseFloat(
    <?php
      $query = "SELECT sum(grade9) as totalavg49 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var xx= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgj3= parseFloat(
    <?php
      $query = "SELECT sum(grade10) as totalavg50 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var yy= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgk3= parseFloat(
    <?php
      $query = "SELECT sum(grade11) as totalavg51 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var zz= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgl3= parseFloat(
    <?php
      $query = "SELECT sum(grade12) as totalavg52 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var aaa= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgm3= parseFloat(
    <?php
      $query = "SELECT sum(grade13) as totalavg53 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var bbb= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgn3= parseFloat(
    <?php
      $query = "SELECT sum(grade14) as totalavg54 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ccc= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgo3= parseFloat(
    <?php
      $query = "SELECT sum(grade15) as totalavg55 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ddd= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgp3= parseFloat(
    <?php
      $query = "SELECT sum(grade16) as totalavg56 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var eee= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgq3= parseFloat(
    <?php
      $query = "SELECT sum(grade17) as totalavg57 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var fff= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgr3= parseFloat(
    <?php
      $query = "SELECT sum(grade18) as totalavg58 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ggg= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgs3= parseFloat(
    <?php
      $query = "SELECT sum(grade19) as totalavg59 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var hhh= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgt3= parseFloat(
    <?php
      $query = "SELECT sum(grade20) as totalavg60 FROM `thirdyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var iii= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avga4= parseFloat(
    <?php
      $query = "SELECT sum(grade) as totalavg61 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var jjj= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgb4= parseFloat(
    <?php
      $query = "SELECT sum(grade2) as totalavg62 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var kkk= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgc4= parseFloat(
    <?php
      $query = "SELECT sum(grade3) as totalavg63 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var lll= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgd4= parseFloat(
    <?php
      $query = "SELECT sum(grade4) as totalavg64 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var mmm= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avge4= parseFloat(
    <?php
      $query = "SELECT sum(grade5) as totalavg65 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var nnn= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgf4= parseFloat(
    <?php
      $query = "SELECT sum(grade6) as totalavg66 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ooo= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgg4= parseFloat(
    <?php
      $query = "SELECT sum(grade7) as totalavg67 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ppp= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgh4= parseFloat(
    <?php
      $query = "SELECT sum(grade8) as totalavg68 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var qqq= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgi4= parseFloat(
    <?php
      $query = "SELECT sum(grade9) as totalavg69 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var rrr= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgj4= parseFloat(
    <?php
      $query = "SELECT sum(grade10) as totalavg70 FROM `midyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var sss= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avga5= parseFloat(
    <?php
      $query = "SELECT sum(grade) as totalavg71 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ttt= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgb5= parseFloat(
    <?php
      $query = "SELECT sum(grade2) as totalavg72 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var uuu= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgc5= parseFloat(
    <?php
      $query = "SELECT sum(grade3) as totalavg73 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var vvv= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgd5= parseFloat(
    <?php
      $query = "SELECT sum(grade4) as totalavg74 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var www= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avge5= parseFloat(
    <?php
      $query = "SELECT sum(grade5) as totalavg75 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var xxx= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgf5= parseFloat(
    <?php
      $query = "SELECT sum(grade6) as totalavg76 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var yyy= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgg5= parseFloat(
    <?php
      $query = "SELECT sum(grade7) as totalavg77 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var zzz= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgh5= parseFloat(
    <?php
      $query = "SELECT sum(grade8) as totalavg78 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var aaaa= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgi5= parseFloat(
    <?php
      $query = "SELECT sum(grade9) as totalavg79 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var bbbb= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgj5= parseFloat(
    <?php
      $query = "SELECT sum(grade10) as totalavg80 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var cccc= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgk5= parseFloat(
    <?php
      $query = "SELECT sum(grade11) as totalavg81 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var dddd= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgl5= parseFloat(
    <?php
      $query = "SELECT sum(grade12) as totalavg82 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var eeee= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgm5= parseFloat(
    <?php
      $query = "SELECT sum(grade13) as totalavg83 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var ffff= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgn5= parseFloat(
    <?php
      $query = "SELECT sum(grade14) as totalavg84 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var gggg= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgo5= parseFloat(
    <?php
      $query = "SELECT sum(grade15) as totalavg85 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var hhhh= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgp5= parseFloat(
    <?php
      $query = "SELECT sum(grade16) as totalavg86 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var iiii= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgq5= parseFloat(
    <?php
      $query = "SELECT sum(grade17) as totalavg87 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var jjjj= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgr5= parseFloat(
    <?php
      $query = "SELECT sum(grade18) as totalavg88 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var kkkk= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgs5= parseFloat(
    <?php
      $query = "SELECT sum(grade19) as totalavg89 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var llll= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
  ...
  var avgt5= parseFloat(
    <?php
      $query = "SELECT sum(grade20) as totalavg90 FROM `fourthyearis` WHERE `studentid`= '$studentid'";
      $results = mysqli_query($link,$query);
