  ...
  <body>
    ...
    <div class="sidemenu">
      ...
      <img src="images/ccs.jpg" id="img2"></img>
        <ul>
          <a href="isstudentportal.php"><li class="l2">Dashboard</li></a>
        </ul>
        <ul>
          <a href="studentgradeis.php"><li class="l3">Your Grades</li></a>
        </ul>
        <ul>
          <a href="changepass2.php"><li class="l1">Change Password</li></a>
        </ul>
    ...
    <div class="dialogbox">
       <form action="upuseraccount2.php" method="POST">
              <?php
              $studentid=$_SESSION['studentid'];
              $password=$_SESSION['password'];
              ?>
              <?php
              $query = "SELECT studentid,password FROM `useris` WHERE `studentid`= '$studentid'";
