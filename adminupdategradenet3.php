...
<body>
	...
	<p style="color:white;background:black;width:100%;text-align: center;font-family: Arial Black;padding:30px 0 30px 0;font-size: 30px; text-shadow: 3px 3px 0 skyblue;"><marquee>THIRD YEAR NET</marquee></p>
	<br><br><br>
<br><br>
...
<br><br><br><br>
	<div class="header">
	<form action="adminupdategradenet3copy.php" method="POST">
