    ...
    <center><div class="table">
      <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="average.php?name=<?php echo $result['name'];?>" id="print">Calc Average</a></td>
            </tr>
            <?php
      }
      } else {
      ...
      <?php
            ...
            <tr>
                ...
                <td><?php echo $result['studentid'];?></td>
                <td><?php echo $result['course'];?></td>
                <td><a href="averageis.php?name=<?php echo $result['name'];?>" id="print">Calc Average</a></td>
            </tr>
            <?php
      }
      } else {
