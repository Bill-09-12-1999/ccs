...
<div class="links">
	<a href="facultyitrog3_1.php" >IT WEB</a>
	<a href="facultyitnetrog3_1.php" id="active">IT NET</a>
	<a href="facultyisrog3_1.php">IS</a>
</div>
<br><br><br>
	<div class="header">
	<form action="facultyitnetrog3_1copy.php" method="POST">
	...
	<label>
		Course/Year/Section: <input type="text" name="course" value="BSIT" id="course"
		style="width: 10%;
		border-style: solid;
		border: 1px solid black;
		border-top-color: white;
		border-left-color: white;
		border-right-color: white;">/
		<input type="text" name="section" value="III - " id="section"
		style="width: 10%;
		border-style: solid;
		border: 1px solid black;
		border-top-color: white;
	...
	<label>
		Semester: <input type="text" name="sem" value="MidYear" id="sem"
		style="width: 10%;
		border-style: solid;
		border: 1px solid black;
		border-top-color: white;
	...
	<label>
		AY: <input type="text" name="AY" value="20" id="AY"
		style="width: 10%;
		border-style: solid;
		border: 1px solid black;
		border-top-color: white;
