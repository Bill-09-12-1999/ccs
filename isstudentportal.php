  ...
  <body>
    <div class="sidemenu">
      ...
      <img src="images/ccs.jpg" id="img2"></img>
        ...
        <ul>
          <a href="studentgradeis.php"><li class="l3">Your Grades</li></a>
        </ul>
        <ul>
          <a href="changepass2.php"><li class="l3">Change Password</li></a>
        </ul>
...
<div style="width:15px; height:15px; position:absolute;z-index:1;background:white;top:0;
    right:0;margin-top: 7.7%;margin-right: 23%;transform: rotate(45deg); display:none;" id="arrow2"></div>
