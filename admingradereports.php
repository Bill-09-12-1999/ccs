  ...
  <body>
    <div class="sidemenu">
      ...
      <img src="images/ccs.jpg" id="img2"></img>
        ...
        <ul>
          <a href="admingradereports.php"><li class="l1"> Admin ROG</li></a>
        </ul>
    ...
    <div class="links">
      <a href="adminitrog1.php">First Year</a>
      <a href="adminitrog2.php">Second Year</a>
      <a href="adminitrog3.php">Third Year</a><br><br><br><br>
      <a href="adminitrog3_1.php" style="padding:70px 60px;">Mid Year</a>
      <a href="adminitrog4.php">Fourth Year</a>
    </div>
