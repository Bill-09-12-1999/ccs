...
<body>
	...
	<p style="color:white;background:black;width:100%;text-align: center;font-family: Arial Black;padding:30px 0 30px 0;font-size: 30px; text-shadow: 3px 3px 0 skyblue;"><marquee>FOURTH YEAR NET</marquee></p>
	<br><br><br>
<br><br>
...
<br><br><br><br>
	<div class="header">
	<form action="adminupdategradenet5copy.php" method="POST">
	...
	<center><a href="stulist.php" style="font-family: Arial Black;font-size: 20px;">Back</a></center><br><br><br><br><br><br><br><br>
</div>
</form>
