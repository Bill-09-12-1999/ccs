...
<div id="accessbutton2">
    ...
    <div class="formmsgtoadmin2" id="form2">
      <div style="position:absolute;top:0;margin-top: 4%; margin-left: 35%; background:white;width:500px;height:70%;border-radius: 10px;padding:20px;font-family: arial; font-size: 20px; overflow:auto;" id="exform">
        ...
        <form action="deanlisterqua.php" method="POST">
...
<div class="BSIS" id="BSIS" style="display:none;">
	<?php
	$query = "SELECT * FROM `firstyear` WHERE `name`='$name'";
    $results=mysqli_query($link,$query);
	...
	?>
    <a href="averagenet.php?name=<?php echo $result['name'];?>">NET</a>
...
<div class="BSIT" id="BSIT" style="display:none;">
	<?php
	$query = "SELECT * FROM `firstyear` WHERE `name`='$name'";;
  $results=mysqli_query($link,$query);
    if(mysqli_num_rows($results)>=1) {
                while($result=mysqli_fetch_array($results)){
	?>
    <a href="average.php?name=<?php echo $result['name'];?>">WEB</a>
    <?php
      }
      } else {
?>
...
<?php } ?>
	...
	<div class="header">
		...
		<p style="position:relative;margin-top:-15px;">BACHELOR OF SCIENCE IN INFORMATION TECHNOLOGY<br>(Compliant to CMO 25, s.2015 and CMO 20, s.2013)<br>Effective School Year 2018-2019<br>
			<b>Networking and Cybersecurity Track</b></p>
	...
	<div class="body">
		...
		<?php
		    $query = "SELECT * FROM `secondyear` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
		...
		<?php
		    $query = "SELECT * FROM `thirdyearnet` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
		...
		<?php
		    $query = "SELECT * FROM `midyearnet` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>

		<h4 style="text-align: center; position:relative;margin-top: -150px;right:-300px;">MIDYEARnet</h4>
		...
		<?php
		    $query = "SELECT * FROM `fourthyearnet` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
...
<script>
	var a= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avga= parseFloat(
    <?php
      $query = "SELECT sum(grade) as totalavg FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var b= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgb= parseFloat(
    <?php
      $query = "SELECT sum(grade2) as totalavg2 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var c= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgc= parseFloat(
    <?php
      $query = "SELECT sum(grade3) as totalavg3 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var d= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgd= parseFloat(
    <?php
      $query = "SELECT sum(grade4) as totalavg4 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var e= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avge= parseFloat(
    <?php
      $query = "SELECT sum(grade5) as totalavg5 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var f= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgf= parseFloat(
    <?php
      $query = "SELECT sum(grade6) as totalavg6 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var g= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgg= parseFloat(
    <?php
      $query = "SELECT sum(grade7) as totalavg7 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var h= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgh= parseFloat(
    <?php
      $query = "SELECT sum(grade8) as totalavg8 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var i= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgi= parseFloat(
    <?php
      $query = "SELECT sum(grade9) as totalavg9 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var j= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgj= parseFloat(
    <?php
      $query = "SELECT sum(grade10) as totalavg10 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var k= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgk= parseFloat(
    <?php
      $query = "SELECT sum(grade11) as totalavg11 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var l= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgl= parseFloat(
    <?php
      $query = "SELECT sum(grade12) as totalavg12 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var m= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgm= parseFloat(
    <?php
      $query = "SELECT sum(grade13) as totalavg13 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var n= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgn= parseFloat(
    <?php
      $query = "SELECT sum(grade14) as totalavg14 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var o= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgo= parseFloat(
    <?php
      $query = "SELECT sum(grade15) as totalavg15 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var p= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgp= parseFloat(
    <?php
      $query = "SELECT sum(grade16) as totalavg16 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var q= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgq= parseFloat(
    <?php
      $query = "SELECT sum(grade17) as totalavg17 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var r= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgr= parseFloat(
    <?php
      $query = "SELECT sum(grade18) as totalavg18 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var s= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgs= parseFloat(
    <?php
      $query = "SELECT sum(grade19) as totalavg19 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var t= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var avgt= parseFloat(
    <?php
      $query = "SELECT sum(grade20) as totalavg20 FROM `firstyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var u= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade) as totalavg21 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var v= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade2) as totalavg22 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var w= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade3) as totalavg23 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var x= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade4) as totalavg24 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var y= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade5) as totalavg25 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var z= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade6) as totalavg26 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aa= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade7) as totalavg27 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bb= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade8) as totalavg28 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var cc= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade9) as totalavg29 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var dd= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade10) as totalavg30 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ee= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade11) as totalavg31 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ff= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade12) as totalavg32 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var gg= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade13) as totalavg33 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hh= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade14) as totalavg34 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ii= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade15) as totalavg35 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jj= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade16) as totalavg36 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kk= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade17) as totalavg37 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ll= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade18) as totalavg38 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var mm= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade19) as totalavg39 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var nn= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade20) as totalavg40 FROM `secondyear` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var oo= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade) as totalavg41 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var pp= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade2) as totalavg42 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var qq= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade3) as totalavg43 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var rr= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade4) as totalavg44 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ss= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade5) as totalavg45 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var tt= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade6) as totalavg46 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var uu= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade7) as totalavg47 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var vv= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade8) as totalavg48 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ww= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade9) as totalavg49 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var xx= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade10) as totalavg50 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var yy= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade11) as totalavg51 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var zz= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade12) as totalavg52 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aaa= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade13) as totalavg53 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bbb= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade14) as totalavg54 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ccc= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade15) as totalavg55 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ddd= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade16) as totalavg56 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var eee= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade17) as totalavg57 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var fff= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade18) as totalavg58 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ggg= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade19) as totalavg59 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hhh= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade20) as totalavg60 FROM `thirdyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var iii= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade) as totalavg61 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jjj= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade2) as totalavg62 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kkk= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade3) as totalavg63 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var lll= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade4) as totalavg64 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var mmm= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade5) as totalavg65 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var nnn= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade6) as totalavg66 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ooo= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade7) as totalavg67 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ppp= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade8) as totalavg68 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var qqq= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade9) as totalavg69 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var rrr= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade10) as totalavg70 FROM `midyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var sss= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade) as totalavg71 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ttt= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade2) as totalavg72 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var uuu= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade3) as totalavg73 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var vvv= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade4) as totalavg74 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var www= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade5) as totalavg75 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var xxx= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade6) as totalavg76 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var yyy= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade7) as totalavg77 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var zzz= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade8) as totalavg78 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aaaa= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade9) as totalavg79 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bbbb= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade10) as totalavg80 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var cccc= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade11) as totalavg81 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var dddd= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade12) as totalavg82 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var eeee= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade13) as totalavg83 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ffff= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade14) as totalavg84 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var gggg= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade15) as totalavg85 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hhhh= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade16) as totalavg86 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var iiii= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade17) as totalavg87 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jjjj= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade18) as totalavg88 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kkkk= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade19) as totalavg89 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var llll= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
    ...
    <?php
      $query = "SELECT sum(grade20) as totalavg90 FROM `fourthyearnet` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
