  ...
  <body>
    ...
    $result= mysqli_fetch_array($results);
     ...
     <div class="regis">
        ...
        <table>
        	<tr>
        		<th>Name: <b><i><u><?php echo $result['name'];?></i></u></b></th>
        		<th>ID NO: <b><i><u><?php echo $result['studentid'];?></i></u></b></th>
        	</tr>
        	<tr>
        		<th>Course: <b><i><u><?php echo $result['course'];?></i></u></b></th>
        ...
        <center><a href="isstudentrogrecords.php"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-circle-fill back" viewBox="0 0 16 16">
