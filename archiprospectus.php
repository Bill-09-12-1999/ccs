...
<button onclick="window.print()" id="printer">
    ...
    <a href="unarchiving1.php?name=<?php echo $fetch['name']?>" id="archi1">Un-Archive Records</a>
    			<?php
						}
	?>
...
<?php } ?>
	...
	<div class="body">
		...
		<?php
		    $query = "SELECT * FROM `archive3` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
    ?>
		...
		<?php
		    $query = "SELECT * FROM `archive3_1` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
    ?>

		<h4 style="text-align: center; position:relative;margin-top: -150px;right:-300px;">archive3_1</h4>
		...
		<?php
		    $query = "SELECT * FROM `archive4` WHERE `name`= '$name'";
		    $results = mysqli_query($link,$query);
		    $result= mysqli_fetch_array($results);
     	?>
...
<script>
	...
	var oo= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var pp= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var qq= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var rr= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ss= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var tt= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var uu= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var vv= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ww= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var xx= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var yy= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var zz= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aaa= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bbb= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ccc= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ddd= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var eee= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var fff= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ggg= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hhh= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `archive3` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var iii= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jjj= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kkk= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var lll= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var mmm= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var nnn= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ooo= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ppp= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var qqq= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var rrr= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `archive3_1` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var sss= parseInt(
    <?php
      $query = "SELECT sum(units) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ttt= parseInt(
    <?php
      $query = "SELECT sum(units2) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var uuu= parseInt(
    <?php
      $query = "SELECT sum(units3) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var vvv= parseInt(
    <?php
      $query = "SELECT sum(units4) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var www= parseInt(
    <?php
      $query = "SELECT sum(units5) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var xxx= parseInt(
    <?php
      $query = "SELECT sum(units6) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var yyy= parseInt(
    <?php
      $query = "SELECT sum(units7) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var zzz= parseInt(
    <?php
      $query = "SELECT sum(units8) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var aaaa= parseInt(
    <?php
      $query = "SELECT sum(units9) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var bbbb= parseInt(
    <?php
      $query = "SELECT sum(units10) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var cccc= parseInt(
    <?php
      $query = "SELECT sum(units11) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var dddd= parseInt(
    <?php
      $query = "SELECT sum(units12) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var eeee= parseInt(
    <?php
      $query = "SELECT sum(units13) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var ffff= parseInt(
    <?php
      $query = "SELECT sum(units14) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var gggg= parseInt(
    <?php
      $query = "SELECT sum(units15) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var hhhh= parseInt(
    <?php
      $query = "SELECT sum(units16) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var iiii= parseInt(
    <?php
      $query = "SELECT sum(units17) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var jjjj= parseInt(
    <?php
      $query = "SELECT sum(units18) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var kkkk= parseInt(
    <?php
      $query = "SELECT sum(units19) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
	...
	var llll= parseInt(
    <?php
      $query = "SELECT sum(units20) as total FROM `archive4` WHERE `name`= '$name'";
      $results = mysqli_query($link,$query);
