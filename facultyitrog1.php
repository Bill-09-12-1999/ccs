...
<style>
	*{
    ...
    .formmsgtoadmin h1{
      ...
      color: white;
      letter-spacing: 2px;
      text-shadow: 0px 5px 3px #000000, 0px 8px 5px #bfbf1e;
      background: linear-gradient(to top,#3c006aa1,rgb(0 0 0),#453197e0);
      padding: 15px;
      border-radius: 10px;
    }
...
<div class="links">
	<a href="facultyitrog1.php" id="active">IT WEB</a>
	<a href="facultyisrog1.php">IS</a>
	<button onclick="openForm()" id="open">UPLOAD SVG</button>
</div>
...
<br><br><br><br>
	<div class="header">
	<form action="facultyitrog1copy.php" method="POST">
