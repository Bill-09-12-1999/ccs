    ...
    <center><div class="table">
      <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="prospectus.php?name=<?php echo $result['name'];?>" id="print">Convert Prospectus</a></td>
            </tr>
            <?php
      }
      } else {
      ...
      <?php
            ...
            <tr>
                ...
                <td><?php echo $result['studentid'];?></td>
                <td><?php echo $result['course'];?></td>
                <td><a href="prospectusis.php?name=<?php echo $result['name'];?>" id="print">Convert Prospectus</a></td>
            </tr>
            <?php
      }
      } else {
